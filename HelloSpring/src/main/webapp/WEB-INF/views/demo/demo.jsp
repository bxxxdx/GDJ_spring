...
<section id="content">
	<div id="demo-container">
		...
		<form id="devFrm" method="post">
			...
			<div class="form-group row">
				<div class = "col-sm-12">
					<button type="button" class="btn btn-outline-primary col-sm-12" onclick="requestSend('demo/demo1.do')">Spring을 서블릿처럼 이용하기</button>
				</div>
			</div>
			<div class="form-group row">
				<div class = "col-sm-12">
					<button type="button" class="btn btn-outline-primary col-sm-12" onclick="requestSend('demo/demo2.do')">1:1로 매칭해서 데이터 받기</button>
				</div>
			</div>
			<div class="form-group row">
				<div class = "col-sm-12">
					<button type="button" class="btn btn-outline-primary col-sm-12" onclick="requestSend('demo/demo3.do')">@RequestParam사용하기</button>
				</div>
			</div>
			<div class="form-group row">
				<div class = "col-sm-12">
					<button type="button" class="btn btn-outline-primary col-sm-12" onclick="requestSend('demo/demo4.do')">vo객체로 바로 받기</button>
				</div>
			</div>
			<div class="form-group row">
				<div class = "col-sm-12">
					<button type="button" class="btn btn-outline-primary col-sm-12" onclick="requestSend('demo/demo5.do')">Map객체로 바로 받기</button>
				</div>
			</div>
			<div class="form-group row">
				<div class = "col-sm-12">
					<button type="button" class="btn btn-outline-primary col-sm-12" onclick="requestSend('demo/demo6.do')">추가 데이터 확인</button>
				</div>
			</div>
			<div class="form-group row">
				<div class = "col-sm-12">
